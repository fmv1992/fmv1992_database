...
-- Running upgrade aaaaaaaaaaaa -> 5fb5dbb091a1
...
CREATE TABLE fmv1992_books.book (
    isbn13 VARCHAR NOT NULL, 
    name VARCHAR NOT NULL, 
    citation_abbreviation VARCHAR NOT NULL, 
    PRIMARY KEY (isbn13)
);
...
CREATE TABLE fmv1992_backup_system.backup (
    id VARCHAR(32) NOT NULL, 
    timestamp TIMESTAMP WITH TIME ZONE NOT NULL, 
...
COMMENT ON COLUMN fmv1992_backup_system.backup.id IS 'Unique ID of every primary blob.
...
COMMENT ON COLUMN fmv1992_backup_system.backup.timestamp IS 'Timestamp associated with the backed up file/binary blob.';

UPDATE alembic_version SET version_num='5fb5dbb091a1' WHERE alembic_version.version_num = 'aaaaaaaaaaaa';
